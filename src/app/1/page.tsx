...
const DEFAULT_DATA: PageData = {
  title: "1年生ライブ",
  eventInfo: "2/19 (土) @ LIVE SPOT WOW! TICKET: ¥1000 + (1drink600)",
  bgImage: "/pexels-bdna-2807495.jpg",
  bgOpacity: 50,
  rows: [
    { time: "11:30", bandName: "KANA-BOON", university: "下市" },
    { time: "12:00", bandName: "ブロッコリー", university: "ひびきの" },
    { time: "12:30", bandName: "すりぃ", university: "福教大" },
    { time: "13:00", bandName: "マカロニえんぴつ", university: "西工大" },
    { time: "13:30", bandName: "SIX LOUNGE", university: "スピ" },
    { time: "14:00", bandName: "UNFAIR RULE", university: "九女" },
    { time: "14:30", bandName: "ELLEGARDEN", university: "野次馬" },
    { time: "15:00", bandName: "SPYAIR", university: "Soes" },
    { time: "15:30", bandName: "Maki", university: "共立" },
    { time: "16:00", bandName: "SILENT SIREN", university: "歯科大" },
    { time: "16:30", bandName: "KANA-BOON", university: "Soes" },
    { time: "17:00", bandName: "UNISON SQUARE GARDEN", university: "スピ" },
  ],
};
          ...
          <div className="container bg-cover mx-1 overflow-hidden relative">
            ...
            <div className="z-10 relative m-2 text-red-500">
              <div className="flex flex-col justify-center items-center gap-2 pb-4">
                ...
                <div className="text-lg font-semibold">{eventInfo}</div>
              </div>
            </div>
          ...
          <div className="container bg-cover mx-1 overflow-hidden relative">
            ...
            <div className="z-10 relative m-1 text-red-500">
              <div className="flex flex-col justify-center items-center gap-2 pb-1">
                <h3 className="text-2xl pt-4 text-center font-bold">{title}</h3>
                <div className="text-sm font-semibold text-center">{eventInfo}</div>
              </div>
            </div>
...
export default function FirstYearLive() {
  return (
